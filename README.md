# Project 2 - *TwitterCodePathProject*

**TwitterCodePathProject** is an android app that allows a user to view his Twitter timeline. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='https://github.com/FedericoRubino/TwitterCodePathProject/blob/master/TwitterAssignment3.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
# Project 2 - *TwitterCodePathProject Part 2*

**TwitterCodePathProject** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='https://github.com/FedericoRubino/TwitterCodePathProject/blob/master/TwitterAssignment4.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
